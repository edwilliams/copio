...
;(function (global, factory) {
  ...
  var loopCreate = function () {
    ...
    for (var i$2 = prependSlides.length - 1; i$2 >= 0; i$2 -= 1) {
      $wrapperEl.prepend(
        $$1(prependSlides[i$2].cloneNode(true)).addClass(params.slideDuplicateClass)
      )
    }
  }
  ...
  var setBreakpoint = function () {
    ...
    if (breakpoint && swiper.currentBreakpoint !== breakpoint) {
      var breakPointsParams =
        breakpoint in breakpoints ? breakpoints[breakpoint] : swiper.originalParams
  ...
  var Keyboard = {
    handle: function handle(event) {
      ...
      if (
        !swiper.allowSlideNext &&
        ((swiper.isHorizontal() && kc === 39) || (swiper.isVertical() && kc === 40))
      ) {
        return false
      }
      if (
        !swiper.allowSlidePrev &&
        ((swiper.isHorizontal() && kc === 37) || (swiper.isVertical() && kc === 38))
      ) {
        return false
      }
  ...
  var Scrollbar = {
    ...
    setDragPosition: function setDragPosition(e) {
      ...
      var positionRatio
      positionRatio =
        (pointerPosition - $el.offset()[swiper.isHorizontal() ? 'left' : 'top'] - dragSize / 2) /
        (trackSize - dragSize)
  ...
  var Controller = {
    ...
    setTranslate: function setTranslate(setTranslate$1, byController) {
      ...
      function setControlledTranslate(c) {
        ...
        var translate =
          c.rtl && c.params.direction === 'horizontal' ? -swiper.translate : swiper.translate
